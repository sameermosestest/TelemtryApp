...
-Dotel.exporter.otlp.traces.headers=apptracekey=apptracevalue \
-Dotel.exporter.otlp.metrics.headers=appmetricskey=appmetricsvalue \
-Dotel.exporter.otlp.logs.headers=applogskey=applogsvalue \
